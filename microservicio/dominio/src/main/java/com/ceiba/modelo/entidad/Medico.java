...
public class Medico {
	...
	private static final String SE_DEBE_INGRESAR_EL_NUMERO_DE_TARJETA_PROFESIONAL = "Se debe ingresar el n\u00famero de tarjeta profesional del m\u00e9dico";
	...
	public Medico(Long id, String nombres, String apellidos, LocalDateTime fechaCreacion, String identificacion,
			String email, String especialidad, String numeroTarjetaProfesional) {
		...
		validarObligatorio(numeroTarjetaProfesional, SE_DEBE_INGRESAR_EL_NUMERO_DE_TARJETA_PROFESIONAL);
		validarNumerico(numeroTarjetaProfesional, EL_VALOR_INGRESADO_DEBE_SER_NUMERICO);
