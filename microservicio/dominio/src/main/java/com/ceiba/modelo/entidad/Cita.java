...
public class Cita {
	...
	private static final String LA_CITA_DEBE_TENER_UN_PRECIO = "La cita debe tener un precio";
	...
	public Cita(Long id, LocalDateTime fechaCita, Long idPaciente, Long idMedico, Double precio) {
		...
		validarObligatorio(precio, LA_CITA_DEBE_TENER_UN_PRECIO);
